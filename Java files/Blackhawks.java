...
public class Blackhawks extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Blackhawks TextViews to link with XML
        ...
        //Creates an instance of the getBlackhawksStats class and executes it
        new getBlackhawksStats().execute();
    }
    ...
    */
    /**/
    public class getBlackhawksStats extends AsyncTask<Void, Void, Void> {
        ...
        */
        ...
        protected Void doInBackground(Void... voids) {
            final String url = "https://www.hockey-reference.com/teams/CHI/";
