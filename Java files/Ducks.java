...
public class Ducks extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Ducks TextViews to link with XML
        ...
        //Creates an instance of the getDucksStats class and executes it
        new getDucksStats().execute();
    }
    ...
    */
    /**/
    public class getDucksStats extends AsyncTask<Void, Void, Void> {
        ...
        */
        ...
        protected Void doInBackground(Void... voids) {
            final String url = "https://www.hockey-reference.com/teams/ANA/";
            ...
            try {
                ...
                //Remove garbage values
                int positionIndex = positionArr.size() - positionArr.size();
