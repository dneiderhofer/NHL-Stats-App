...
public class Stars extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Stars TextViews to link with XML
        ...
        //Creates an instance of the getStarsStats class and executes it
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        new getStarsStats().execute();
    }
    ...
    */
    /**/
    public class getStarsStats extends AsyncTask<Void, Void, Void> {
        ...
        */
        ...
        protected Void doInBackground(Void... voids) {
            final String url = "https://www.hockey-reference.com/teams/DAL/";
