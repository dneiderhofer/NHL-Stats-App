...
public class Avalanche extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //Allows the code to be run behind the scenes for the activities for this class
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blue_jackets);

        //Avalanche TextViews to link with XML
        ...
        //Shows the header of the page when opened
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        //Creates an instance of the getAvalancheStats class and executes it
        new getAvalancheStats().execute();
    }
    ...
    */
    /**/
    public class getAvalancheStats extends AsyncTask<Void, Void, Void> {
        //Variables used when getting the data from HTML
        ...
        */
        ...
        protected Void doInBackground(Void... voids) {
            //URL for getting the HTML for this class
            final String url = "https://www.hockey-reference.com/teams/COL/";
