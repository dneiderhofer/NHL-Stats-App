...
public class Islanders extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devils);

        //Islanders TextViews to link with XML
        ...
        //Creates an instance of the getIslandersStats class and executes it
        new getIslandersStats().execute();
    }
    ...
    */
    /**/
    public class getIslandersStats extends AsyncTask<Void, Void, Void> {
        ...
        */
        ...
        protected Void doInBackground(Void... voids) {
            final String url = "https://www.hockey-reference.com/teams/NYI/";
            ...
            try {
                ...
                //Index calculations for removing garbage
